...
> Paste this into the claude.ai Project's **custom instructions** field. It tells
> every future chat how to behave so work stays high-quality and token-efficient.
> Keep the canonical docs (`PROJECT_BRIEF.md`, `ARCHITECTURE.md`,
> `DATA_DICTIONARY.csv`, `DECISION_LOG.md`) in the Project's knowledge.
